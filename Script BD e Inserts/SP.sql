...
BEGIN
SELECT B.IDBOLETO as "idBoleto", E.idEvento as "idEvento", E.NOMBRE, B.FILA as "Fila", B.ASIENTO  as "Asiento", E.FECHA as "Fecha", B.CIUDAD as "Ciudad", B.precio as "precio"
FROM BOLETOS AS B
