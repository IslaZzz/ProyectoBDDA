...
public class BoletosDAO {
    ...
    /**
     * Consultar los boletos por usuarios, devuelve una lista con los boletos
     * que coinciden con el id del usuario recibido en el parametro
     *
     * @param usuario
     * @return
     */
    ...
    /**
     * Método que genera el numero de serie del boleto (ID) para el momento de
     * registrar boleto
     *
     * @param fila
     * @param asiento
    ...
    /**
     *Método que retorna el nombre del evento dado un boleto
     * @param boleto
     * @return
     */
